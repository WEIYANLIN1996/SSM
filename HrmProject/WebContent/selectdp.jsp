...
<script type="text/javascript">
    	function gotopage(currentpage){
    		if(currentpage<1 || currentpage!=parseInt(currentpage) || currentpage>'${pagebean.totalpage}'){
	    		...
	    		window.location.href = '${pageContext.request.contextPath}/SelectDpServlet?currentpage=' + currentpage + '&pagesize=' + pagesize;
    		}
    	}
    	...
    	function changesize(pagesize,oldvalue){
    		if(pagesize<0 || pagesize!=parseInt(pagesize)){
    			...
    			window.location.href = '${pageContext.request.contextPath}/SelectDpServlet?pagesize=' + pagesize;
    		}
}
    </script>
</html>