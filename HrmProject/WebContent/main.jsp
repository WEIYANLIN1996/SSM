			...
			<div style="position: relative;">
				...
				<table style="position: absolute; left: 75%; top: 15px;">
					<tr>
						...
						<td style="width: 120px"><a href="http://localhost:8080/HrmProject/"
					...
					<div style="width: 100%">
						<table style="margin-left: 50px; margin-top: 7px">
							<tr>
								...
								<td>当前用户:<span>${sessionScope.loginname}</span></td>
		...
		<div data-options="region:'west',iconCls:'icon-clipart',"
			...
			<div class="easyui-accordion">
				...
				<div title="部门管理" data-options="iconCls:'icon-edit'"
					style="overflow: auto; padding: 10px; height: 200px">
					<a href="#" class="easyui-linkbutton"
						data-options="plain:true,iconCls:'icon-zoom'" id="selectdp">部门查询</a> <a href="#"
						class="easyui-linkbutton"
						data-options="plain:true,iconCls:'icon-add'" id="adddp">添加部门</a>
				</div>
				<div title="职位管理" data-options="iconCls:'icon-remove'"
					style="overflow: auto; padding: 10px; height: 200px">
					<a href="#" class="easyui-linkbutton"
						data-options="plain:true,iconCls:'icon-zoom'" id="selectpst">职位查询</a> <a href="#"
						class="easyui-linkbutton"
						data-options="plain:true,iconCls:'icon-add'" id="addpst">添加职位</a>
				</div>
				<div title="员工管理" data-options="iconCls:'icon-user'"
					style="overflow: auto; padding: 10px; height: 200px">
					<a href="#" class="easyui-linkbutton"
						data-options="plain:true,iconCls:'icon-zoom'" id="selectstaff">员工查询</a> <a href="#"
						class="easyui-linkbutton"
				...
				<div title="公告管理" data-options="iconCls:'icon-ok'"
					style="overflow: auto; padding: 10px; height: 200px">
					<a href="#" class="easyui-linkbutton"
						data-options="plain:true,iconCls:'icon-print'" id="selectaun">公告查询</a> <a
						href="#" class="easyui-linkbutton"
						data-options="plain:true,iconCls:'icon-add'" id="addaun">添加公告</a>
				</div>
...
<script>
	...
	$(function() {//jq的页面加载完成事件
		...
		//部门查询
		$("#selectdp").click(function() {
			addTab("#usertab", "部门查询", "icon-zoom", "SelectDpServlet");
		});
		$("#adddp").click(function() {
			addTab("#usertab", "添加部门", "icon-groupadd", "adddp.jsp");
		});
		//职位查询
		$("#selectpst").click(function() {
			addTab("#usertab", "职位查询", "icon-zoom", "SelectJobServlet");
		});
		$("#addpst").click(function() {
			addTab("#usertab", "添加职位", "icon-groupadd", "addpst.jsp");
		});
		//员工查询
		$("#selectstaff").click(function() {
			addTab("#usertab", "员工查询", "icon-zoom", "SelectStaffServlet");
		});
		$("#addEmp").click(function(){
			addTab("#usertab", "添加员工", "icon-groupadd", "addstaff.jsp");	
			
		});
		//公告查询
		$("#selectaun").click(function() {
			addTab("#usertab", "公告查询", "icon-zoom", "SelectAunServlet");
		});
		$("#addaun").click(function() {
			addTab("#usertab", "添加公告", "icon-groupadd", "addaun.jsp");
		});
		//下载中心
